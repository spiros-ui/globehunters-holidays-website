...
const DESTINATION_HERO_IMAGES: Record<string, string> = {
  ...
  "Hong Kong": "https://images.unsplash.com/photo-1536599018102-9f803c979b5d?w=1200&h=800&fit=crop&q=80",
  ...
  "Milan": "https://images.unsplash.com/photo-1520440229-6469625e2a8f?w=1200&h=800&fit=crop&q=80",
  ...
  "Budapest": "https://images.unsplash.com/photo-1541343672885-9be56236a99e?w=1200&h=800&fit=crop&q=80",
  ...
  "Zanzibar": "https://images.unsplash.com/photo-1547560738-8d7e8df3a07b?w=1200&h=800&fit=crop&q=80",
  "Jordan": "https://images.unsplash.com/photo-1579606032821-4e6161c81571?w=1200&h=800&fit=crop&q=80",
  "Croatia": "https://images.unsplash.com/photo-1555990793-da11153b2473?w=1200&h=800&fit=crop&q=80",
  "Costa Rica": "https://images.unsplash.com/photo-1518259102861-8a3739776c8e?w=1200&h=800&fit=crop&q=80",
...
const DESTINATION_DAY_THEMES: Record<string, Array<{ title: string; desc: string; schedule: string[]; image: string }>> = {
  ...
  jordan: [
    ...
    { title: "Petra", desc: "Rose-red wonder", schedule: ["Early breakfast", "Drive to Petra", "The Siq entrance", "Treasury reveal", "Explore Petra", "Lunch", "Monastery climb", "Petra by Night"], image: "https://images.unsplash.com/photo-1579606032821-4e6161c81571?w=600&h=400&fit=crop&q=80" },
